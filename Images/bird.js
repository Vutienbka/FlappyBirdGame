...
let Bird= function (game) {
    ...
    this.loadImage = function () {
        ...
        midFlapImage.src = 'Images/yellowbird-midflap.png';
        upFlapImage.src = 'Images/yellowbird-upflap.png';
        downFlapImage.src = 'Images/yellowbird-downflap.png';
        ...
        if(self.positionChange==true) {
            if (self.bY <= 480) {
                if (self.direction == 'down') {
                    ...
                    self.flapY -= self.gravity;
                    let audio = new Audio("SoundFiles/fly-sound.mp3");
                    self.flap();
                    audio.play();
                    self.direction = 'down';
                }
